...
const createPage = (pageData: any) => API.post(apiEndpoints.createPage, pageData);
const updatePage = (id: number, pageData: any) => API.put(apiEndpoints.updatePage(id), pageData);
